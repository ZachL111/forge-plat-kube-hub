"""Regression checks for the forge-plat-kube-hub casebook."""
...
from casebook.harness import assert_expected, forge_plat_kube_hub_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(forge_plat_kube_hub_summary(), assert_expected())
